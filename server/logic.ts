...
export function buildSystemPrompt(language: string, assessments: AssessmentAnswer[]): string {
  ...
  style: 'Warm, patient aur empathetic tone rakhein. Pehle reflective listening use karein; exercises bas tab jab timing sahi ho. Jab intervention suggest karein: reason short batao, user ki readiness confirm karo, phir clear step-by-step (①, ②, ③) instructions do. Emotional support aur practical guidance ke beech natural flow banaye rakhein. STRICT: Sabhi responses sirf conversational Hinglish (English letters) me dein; Devanagari/Hindi script ka bilkul istemal na karein.',
