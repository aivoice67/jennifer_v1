...
// Hume removed; keep env for backward compatibility but unused
...
// Only ElevenLabs primary key required now
...
async function generateTTS(text: string, _language: string): Promise<string> {
  // Unified ElevenLabs TTS for all languages (english, spanish, french, hindi, etc.)
  const payload = {
    text,
